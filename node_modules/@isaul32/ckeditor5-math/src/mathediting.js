...
export default class MathEditing extends Plugin {
    ...
    _defineConverters() {
        ...
        function createMathtexEditingView(modelItem, writer) {
            ...
            const styles = 'user-select: none; ' +
                (display ? '' : 'display: inline-block;');
            const classes = 'ck-math-tex ' +
            ...
            const uiElement = writer.createUIElement('div', null, function (domDocument) {
                ...
                void renderEquation(equation, domElement, mathConfig.engine, mathConfig.lazyLoad, display, false, `math-editing-${uid()}`, mathConfig.previewClassName, mathConfig.katexRenderOptions);
                return domElement;
            });
