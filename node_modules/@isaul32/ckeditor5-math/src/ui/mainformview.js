...
import { ButtonView, createLabeledInputText, FocusCycler, LabelView, LabeledFieldView, submitHandler, SwitchButtonView, View, ViewCollection } from 'ckeditor5/src/ui';
...
export default class MainFormView extends View {
    constructor(locale, engine, lazyLoad, previewEnabled = false, previewUid, previewClassName, popupClassName, katexRenderOptions) {
        super(locale);
