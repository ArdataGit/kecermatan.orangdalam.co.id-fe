...
var TagInput = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var onInnerClick = function onInnerClick(context) {
    if (!props.disabled && !props.readonly) {
      ...
      (_tagInputRef$current$ = tagInputRef.current.inputElement) === null || _tagInputRef$current$ === void 0 || (_tagInputRef$current$2 = _tagInputRef$current$.focus) === null || _tagInputRef$current$2 === void 0 || _tagInputRef$current$2.call(_tagInputRef$current$);
    }
  ...
  var classes = [NAME_CLASS, _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, BREAK_LINE_CLASS, excessTagsDisplayType === "break-line"), WITH_SUFFIX_ICON_CLASS, !!suffixIconNode), "".concat(prefix, "-is-empty"), isEmpty), "".concat(prefix, "-tag-input--with-tag"), !isEmpty), props.className];
