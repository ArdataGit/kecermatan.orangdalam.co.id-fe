...
import { getAttach, on, off } from '../_util/dom.js';
...
var Overlay = function Overlay(originalProps) {
  ...
  var hidePopup = hideEmptyPopup && isString_1(content) && ["", void 0, null].includes(content);
...
var renderInstance = function renderInstance(props, attach) {
  return new Promise(function (resolve) {
    render( /* @__PURE__ */React.createElement(Overlay, _objectSpread(_objectSpread({}, props), {}, {
