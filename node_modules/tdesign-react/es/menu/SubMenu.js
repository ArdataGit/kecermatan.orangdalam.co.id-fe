...
var SubAccordion = function SubAccordion(props) {
  ...
  var submenu = /* @__PURE__ */React.createElement("li", {
    ...
    className: classNames("".concat(classPrefix, "-menu__item"), _defineProperty(_defineProperty({}, "".concat(classPrefix, "-is-opened"), isOpen), "".concat(classPrefix, "-is-active"), checkSubMenuChildrenActive(children, active)))
  }, icon, " ", /* @__PURE__ */React.createElement("span", {
    className: "".concat(classPrefix, "-menu__content")
  }, title), /* @__PURE__ */React.createElement(FakeArrow, {
    style: fakeArrowStyle,
    isActive: level === 1 && isOpen,
    disabled: disabled
  })), !isPopUp && /* @__PURE__ */React.createElement("ul", {
    key: "normal",
...
var SubTitleMenu = function SubTitleMenu(props) {
  ...
  var submenu = /* @__PURE__ */React.createElement("li", {
    ...
    onClick: handleClick,
    style: style
  }, /* @__PURE__ */React.createElement("span", null, title), isPopUp && /* @__PURE__ */React.createElement(FakeArrow, {
    style: fakeArrowStyle,
