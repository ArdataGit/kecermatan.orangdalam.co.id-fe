...
var useVirtualScroll = function useVirtualScroll(container, params) {
  ...
  var _useState3 = useState(((data === null || data === void 0 ? void 0 : data.length) || 0) * ((scroll === null || scroll === void 0 ? void 0 : scroll.rowHeight) || 50)),
  ...
  var tripleBufferSize = useMemo(function () {
  ...
  useResizeObserver(isVirtualScroll ? container.current : void 0, refreshVirtualScroll);
  useEffect(function () {
    if (!isVirtualScroll) {
