...
var ImageFlowList = function ImageFlowList(props) {
  ...
  var renderImgItem = function renderImgItem(file, index) {
    ...
    return /* @__PURE__ */React.createElement("li", {
      ...
      className: classNames(["".concat(uploadPrefix, "__card-status-wrap"), "".concat(uploadPrefix, "__").concat(props.theme, "-").concat(file.status)])
    }, iconMap[file.status], /* @__PURE__ */React.createElement("p", null, textMap[file.status])), (["waiting", "success"].includes(file.status) || !file.status && file.url) && /* @__PURE__ */React.createElement(Image, {
  ...
  var renderCancelUploadButton = function renderCancelUploadButton() {
    ...
    if (isFunction_1(cancelUploadButton)) return parseTNode(cancelUploadButton);
    var cancelButtonProps = isObject_1(cancelUploadButton) ? cancelUploadButton : void 0;
  ...
  var renderUploadButton = function renderUploadButton() {
    ...
    if (isFunction_1(uploadButton)) return parseTNode(uploadButton);
    var uploadButtonProps = isObject_1(uploadButton) ? uploadButton : void 0;
    return /* @__PURE__ */React.createElement(Button, _objectSpread({
