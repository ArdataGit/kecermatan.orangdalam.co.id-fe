...
export declare const useTreeSelectUtils: ({ data, treeProps, valueType }: TreeSelectProps, treeRef: MutableRefObject<ElementRef<typeof Tree>>) => {
    getNodeItem: (value: string | number) => import("../_common/js/tree-v1/types").TypeTreeNodeModel | import("../tree").TreeNodeModel<import("../common").TreeOptionData<string | number>>;
