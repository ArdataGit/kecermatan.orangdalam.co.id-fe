...
function renderEllipsisCell(cellParams, params) {
  ...
  if (_typeof(col.ellipsis) === "object" && "content" in col.ellipsis && isFunction_1(col.ellipsis.content)) {
...
var Cell = function Cell(props) {
  ...
  var normalAttrs = isFunction_1(col.attrs) ? col.attrs(_objectSpread(_objectSpread({}, cellParams), {}, {
    type: "td"
  })) : col.attrs;
