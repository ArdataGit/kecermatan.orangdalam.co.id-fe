...
import { i as intersection_1 } from '../../_chunks/dep-4a114726.js';
import { x as xorWith_1 } from '../../_chunks/dep-6a28768e.js';
    ...
    dialogInstance.current = DialogPlugin.confirm(_objectSpread({
      ...
      onConfirm: function onConfirm() {
        if (columnCheckboxKeys.current.length < displayColumns.length) {
          ...
          var reduceKeys = xorWith_1(displayColumns, columnCheckboxKeys.current);
