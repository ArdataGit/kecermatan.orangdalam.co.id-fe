...
var List = forwardRefWithStatics(function (props, ref) {
  ...
  return /* @__PURE__ */React.createElement("div", {
    ...
    className: classNames("".concat(classPrefix, "-list"), className, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(classPrefix, "-list--split"), split), "".concat(classPrefix, "-list--stripe"), stripe), "".concat(classPrefix, "-list--vertical-action"), layout === "vertical"), "".concat(classPrefix, "-size-s"), size === "small"), "".concat(classPrefix, "-size-l"), size === "large"))
