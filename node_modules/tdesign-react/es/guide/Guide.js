...
var Guide = function Guide(originalProps) {
  ...
  var renderCounter = function renderCounter() {
    var popupSlotCounter = isFunction_1(counter) ? counter({
      total: stepsTotal,
      current: innerCurrent
    }) : counter;
  ...
  var renderPopupGuide = function renderPopupGuide() {
    var _currentStepInfo$chil, _currentStepInfo$popu;
    ...
    if ( /*#__PURE__*/React.isValidElement(content)) {
      ...
      renderBody = isFunction_1(content) ? content(contentProps) : /*#__PURE__*/React.cloneElement(content, contentProps);
    } else {
    ...
    return /*#__PURE__*/createPortal( /* @__PURE__ */React.createElement(Popup, _objectSpread(_objectSpread({
      ...
      overlayClassName: ["".concat(prefixCls, "__popup"), currentStepInfo.stepOverlayClass],
      overlayInnerClassName: innerClassName.concat((_currentStepInfo$popu = currentStepInfo.popupProps) === null || _currentStepInfo$popu === void 0 ? void 0 : _currentStepInfo$popu.overlayInnerClassName)
