...
import { _ as _asyncToGenerator, r as regenerator } from '../../_chunks/dep-57f1d6d7.js';
import { _ as _slicedToArray } from '../../_chunks/dep-be37289b.js';
import { i as isEmpty_1 } from '../../_chunks/dep-4f55b93d.js';
import { i as isFunction_1 } from '../../_chunks/dep-70de8f55.js';
import { m as merge_1 } from '../../_chunks/dep-f870baf9.js';
...
function useInstance(props, formRef, formMapRef) {
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            list = _toConsumableArray(formMapRef.current.values()).filter(function (formItemRef) {
              ...
              return isFunction_1(formItemRef === null || formItemRef === void 0 || (_formItemRef$current13 = formItemRef.current) === null || _formItemRef$current13 === void 0 ? void 0 : _formItemRef$current13.validate) && needValidate(formItemRef === null || formItemRef === void 0 || (_formItemRef$current14 = formItemRef.current) === null || _formItemRef$current14 === void 0 ? void 0 : _formItemRef$current14.name, fields);
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            list = _toConsumableArray(formMapRef.current.values()).filter(function (formItemRef) {
              ...
              return isFunction_1(formItemRef === null || formItemRef === void 0 || (_formItemRef$current15 = formItemRef.current) === null || _formItemRef$current15 === void 0 ? void 0 : _formItemRef$current15.validateOnly) && needValidate(formItemRef === null || formItemRef === void 0 || (_formItemRef$current16 = formItemRef.current) === null || _formItemRef$current16 === void 0 ? void 0 : _formItemRef$current16.name, fields);
            }).map(function (formItemRef) {
              var _formItemRef$current$4, _formItemRef$current17;
              return formItemRef === null || formItemRef === void 0 || (_formItemRef$current$4 = (_formItemRef$current17 = formItemRef.current).validateOnly) === null || _formItemRef$current$4 === void 0 ? void 0 : _formItemRef$current$4.call(_formItemRef$current17, trigger);
            });
            _context2.next = 4;
            return Promise.all(list);
          case 4:
  ...
  function getFieldsValue(nameList) {
    ...
    if (nameList === true) {
      ...
      nameList.forEach(function (name) {
        ...
        var fieldValue = calcFieldValue(name, formItemRef === null || formItemRef === void 0 || (_formItemRef$current$3 = (_formItemRef$current3 = formItemRef.current).getValue) === null || _formItemRef$current$3 === void 0 ? void 0 : _formItemRef$current$3.call(_formItemRef$current3));
        merge_1(fieldsValue, fieldValue);
      });
    }
    return fieldsValue;
  ...
  function setFieldsValue() {
    ...
    travelMapFromObject(fields, formMapRef, function (formItemRef, fieldValue) {
      ...
      formItemRef === null || formItemRef === void 0 || (_formItemRef$current4 = formItemRef.current) === null || _formItemRef$current4 === void 0 || (_formItemRef$current5 = _formItemRef$current4.setValue) === null || _formItemRef$current5 === void 0 || _formItemRef$current5.call(_formItemRef$current4, fieldValue, fields);
    });
  }
  function setFields() {
    var fields = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    ...
    fields.forEach(function (field) {
      ...
      var formItemRef = getMapValue(name, formMapRef);
      formItemRef === null || formItemRef === void 0 || (_formItemRef$current6 = formItemRef.current) === null || _formItemRef$current6 === void 0 || _formItemRef$current6.setField(restFields, field);
    });
  }
  function reset(params) {
    if (typeof params === "undefined") {
      _toConsumableArray(formMapRef.current.values()).forEach(function (formItemRef) {
        ...
        formItemRef === null || formItemRef === void 0 || (_formItemRef$current7 = formItemRef.current) === null || _formItemRef$current7 === void 0 || _formItemRef$current7.resetField();
      });
    } else {
      ...
      fields.forEach(function (name) {
        ...
        var formItemRef = getMapValue(name, formMapRef);
        formItemRef === null || formItemRef === void 0 || (_formItemRef$current8 = formItemRef.current) === null || _formItemRef$current8 === void 0 || _formItemRef$current8.resetField(type);
      });
    }
  ...
  function clearValidate(fields) {
    if (typeof fields === "undefined") {
      ...
      fields.forEach(function (name) {
        ...
        var formItemRef = getMapValue(name, formMapRef);
        formItemRef === null || formItemRef === void 0 || (_formItemRef$current10 = formItemRef.current) === null || _formItemRef$current10 === void 0 || _formItemRef$current10.resetValidate();
      });
    }
  }
  function setValidateMessage(message) {
    travelMapFromObject(message, formMapRef, function (formItemRef, fieldValue) {
      ...
      formItemRef === null || formItemRef === void 0 || (_formItemRef$current11 = formItemRef.current) === null || _formItemRef$current11 === void 0 || (_formItemRef$current12 = _formItemRef$current11.setValidateMessage) === null || _formItemRef$current12 === void 0 || _formItemRef$current12.call(_formItemRef$current11, fieldValue);
    });
  }
  return {
    submit: submit,
