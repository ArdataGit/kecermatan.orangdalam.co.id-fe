...
import { i as isObject_1 } from '../_chunks/dep-c2c3c04d.js';
import { i as isString_1 } from '../_chunks/dep-3f719063.js';
...
import '../_chunks/dep-4f55b93d.js';
...
import '../_chunks/dep-5c912097.js';
...
import '../_chunks/dep-fa9be2bf.js';
...
import '../_chunks/dep-9698121f.js';
...
import '../_common/js/tree-v1/tree-store.js';
...
import '../_chunks/dep-b2b25ba0.js';
...
import '../_chunks/dep-7fd39d30.js';
...
var FormItem = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var _useFormContext = useFormContext(),
    ...
    FromContextInitialData = _useFormContext.initialData,
  ...
  var _useState15 = useState(getDefaultInitialData({
      ...
      FromContextInitialData: FromContextInitialData,
      FormListInitialData: FormListInitialData
    })),
              ...
              Object.keys(item).forEach(function (key) {
                if (!item.message && errorMessages[key]) {
                  item.message = parseMessage(errorMessages[key], {
                    validate: item[key],
                    name: isString_1(label) ? label : String(name)
                  });
                }
              });
              return item;
  ...
  return /* @__PURE__ */React.createElement("div", {
    ...
    if ( /*#__PURE__*/React.isValidElement(child)) {
      ...
      return /*#__PURE__*/React.cloneElement(child, _objectSpread(_objectSpread({
      ...
      }, child.props), {}, _defineProperty(_defineProperty(_defineProperty({}, ctrlKey, formValue), "onChange", function onChange(value) {
        ...
        (_child$props$onChange = child.props.onChange) === null || _child$props$onChange === void 0 || (_child$props$onChange2 = _child$props$onChange.call) === null || _child$props$onChange2 === void 0 || _child$props$onChange2.call.apply(_child$props$onChange2, [_child$props$onChange, null, value].concat(args));
        ...
        (_child$props$onBlur = child.props.onBlur) === null || _child$props$onBlur === void 0 || (_child$props$onBlur$c = _child$props$onBlur.call) === null || _child$props$onBlur$c === void 0 || _child$props$onBlur$c.call.apply(_child$props$onBlur$c, [_child$props$onBlur, null, value].concat(args));
      })));
    }
    return child;
