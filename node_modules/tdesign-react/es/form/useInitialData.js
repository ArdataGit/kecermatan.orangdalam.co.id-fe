...
import { C as Checkbox, a as CheckboxGroup } from '../_chunks/dep-5c912097.js';
...
function getDefaultInitialData(_ref) {
  var name = _ref.name,
    ...
    FromContextInitialData = _ref.FromContextInitialData,
    FormListInitialData = _ref.FormListInitialData;
  var defaultInitialData;
  if (FromContextInitialData) {
    if (typeof name === "string") defaultInitialData = get_1(FromContextInitialData, name);
    if (Array.isArray(name)) {
      var nameList = formListName ? [formListName].concat(_toConsumableArray(name)) : name;
      defaultInitialData = get_1(FromContextInitialData, nameList);
    }
  }
  if (FormListInitialData.length) {
    defaultInitialData = get_1(FormListInitialData, name);
  }
  ...
  React.Children.forEach(children, function (child) {
    if (child && /*#__PURE__*/React.isValidElement(child) && typeof defaultInitialData === "undefined") {
      var _child$props;
      var isMultiple = child === null || child === void 0 || (_child$props = child.props) === null || _child$props === void 0 ? void 0 : _child$props.multiple;
