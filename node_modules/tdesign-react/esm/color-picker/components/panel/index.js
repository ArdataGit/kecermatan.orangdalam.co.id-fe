...
import { DEFAULT_LINEAR_GRADIENT, DEFAULT_COLOR, TD_COLOR_USED_COLORS_MAX_SIZE, DEFAULT_SYSTEM_SWATCH_COLORS } from '../../const.js';
...
var Panel = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var value = props.value,
    ...
    _props$showPrimaryCol = props.showPrimaryColorPreview,
    showPrimaryColorPreview = _props$showPrimaryCol === void 0 ? true : _props$showPrimaryCol,
  ...
  var _useState = useState((colorModes === null || colorModes === void 0 ? void 0 : colorModes.length) === 1 ? colorModes[0] : "monochrome"),
  ...
  var formatRef = useRef(colorInstanceRef.current.isGradient ? "CSS" : format !== null && format !== void 0 ? format : "RGB");
  ...
  var formatValue = useCallback(function () {
    ...
    var finalFormat = format === "HEX" && enableAlpha ? "HEX8" : format;
  ...
  var SwatchesArea = /*#__PURE__*/React.memo(function () {
    ...
    var handleSetColor = function handleSetColor(value2, trigger) {
