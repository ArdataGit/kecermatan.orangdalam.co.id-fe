...
export declare function getWeeks({ year, month }: {
    year: number;
    month: number;
}, { firstDayOfWeek, showWeekOfYear, disableDate, minDate, maxDate, dayjsLocale, cancelRangeSelectLimit, }: OptionsType): any[][];
export declare function getQuarters(year: number, { disableDate, minDate, maxDate, quarterLocal, dayjsLocale, cancelRangeSelectLimit, }: OptionsType): any[][];
export declare function getYears(year: number, { disableDate, minDate, maxDate, dayjsLocale, cancelRangeSelectLimit, }: OptionsType): any[][];
