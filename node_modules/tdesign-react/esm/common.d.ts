...
export declare type TElement<T = undefined> = T extends undefined ? ReactElement : (props: T) => ReactElement;
export declare type TNode<T = undefined> = T extends undefined ? ReactNode : ReactNode | ((props: T) => ReactNode);
...
export declare type ImageEvent<T = any> = SyntheticEvent<T>;
/**
 * 通用全局类型
 * */
