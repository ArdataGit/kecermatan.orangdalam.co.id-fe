...
import { d as difference_1 } from '../_chunks/dep-f35eca6f.js';
import classNames from 'classnames';
import { i as isFunction_1 } from '../_chunks/dep-70de8f55.js';
import { i as isArray_1 } from '../_chunks/dep-17c2aa2b.js';
...
var Transfer = function Transfer(originalProps) {
  ...
  var sourceDisabled = isArray_1(disabled) ? disabled[0] : disabled;
  var targetDisabled = isArray_1(disabled) ? disabled[1] : disabled;
  ...
  var _getDefaultValue3 = getDefaultValue(isFunction_1(transferItem) ? transferItem({
      data: data,
      index: void 0,
      type: void 0
    }) : transferItem),
    _getDefaultValue4 = _slicedToArray(_getDefaultValue3, 2),
    sourceTransferItem = _getDefaultValue4[0],
    targetTransferItem = _getDefaultValue4[1];
  var _getDefaultValue5 = getDefaultValue(content),
    _getDefaultValue6 = _slicedToArray(_getDefaultValue5, 2),
    sourceContent = _getDefaultValue6[0],
    targetContent = _getDefaultValue6[1];
