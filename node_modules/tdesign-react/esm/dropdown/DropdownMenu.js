...
import { t as throttle_1 } from '../_chunks/dep-fa9be2bf.js';
...
var DropdownMenu = function DropdownMenu(props) {
  ...
  var throttleUpdate = throttle_1(handleScroll, 100);
    ...
    (_data$forEach = data.forEach) === null || _data$forEach === void 0 || _data$forEach.call(data, function (menu, idx) {
      ...
      if (optionItem.children) {
        ...
        renderContent = /* @__PURE__ */React.createElement("div", {
          ...
          style: {
            position: "absolute",
            top: "".concat(itemIdx * 30 + (isOverflow ? 0 : panelTopContentHeight), "px")
          }
        }, /* @__PURE__ */React.createElement("div", {
  ...
  }, panelTopContent) : null, renderOptions(options, 0), panelBottomContent ? /* @__PURE__ */React.createElement("div", {
