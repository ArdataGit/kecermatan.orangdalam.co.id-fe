...
var Select = forwardRefWithStatics(function (originalProps, ref) {
  ...
  var onTagChange = function onTagChange(_currentTags, context) {
    ...
    if (trigger === "backspace") {
      ...
      var currentSelectedOptions = getSelectedOptions(values, multiple, valueType, keys, tmpPropOptions);
      onChange(values, {
        e: e,
        trigger: trigger,
    ...
    if (trigger === "tag-remove") {
      ...
      var _currentSelectedOptions = getSelectedOptions(_values, multiple, valueType, keys, tmpPropOptions);
      onChange(_values, {
        e: e,
        trigger: trigger,
  ...
  var onCheckAllChange = function onCheckAllChange(checkAll, e) {
    ...
    var selectableOptions = currentOptions.filter(function (option) {
      return !option.checkAll && !option.disabled;
    }).map(function (option) {
      return option.value;
    });
    var checkAllValue = !checkAll && selectableOptions.length !== ((_props$value = props.value) === null || _props$value === void 0 ? void 0 : _props$value.length) ? selectableOptions : [];
    onChange === null || onChange === void 0 || onChange(checkAllValue, {
      e: e,
      trigger: checkAll ? "check" : "uncheck",
      selectedOptions: checkAllValue
    });
  };
  var handleChange = function handleChange(value2, context) {
    ...
    var currentSelectedOptions = getSelectedOptions(value2, multiple, valueType, keys, tmpPropOptions);
    onChange === null || onChange === void 0 || onChange(value2, _objectSpread(_objectSpread({}, context), {}, {
      selectedOptions: currentSelectedOptions
    }));
  };
  var handleFilter = function handleFilter(value2) {
    var filteredOptions = [];
    if (filterable && isFunction_1(onSearch)) {
      return;
    }
    if (!value2) {
    ...
    var isSameLabelOptionExist = filteredOptions.find(function (option) {
      return option.label === value2;
    });
        ...
        return val.slice(0, minCollapsedNum ? minCollapsedNum : val.length).map(function (v, key) {
          ...
          return /* @__PURE__ */React.createElement(Tag, _objectSpread(_objectSpread({
            ...
            onClose: function onClose(_ref3) {
              ...
              var selectedOptions2 = getSelectedOptions(values, multiple, valueType, keys, tmpPropOptions);
              onChange(values, {
                e: e,
