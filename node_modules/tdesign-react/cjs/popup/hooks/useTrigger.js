...
function useTrigger(_ref) {
  ...
  React.useEffect(function () {
    ...
    var handleDocumentClick = function handleDocumentClick(e) {
      ...
      if ((_getRefDom = popup_utils_ref.getRefDom(triggerRef)) !== null && _getRefDom !== void 0 && (_getRefDom$contains = _getRefDom.contains) !== null && _getRefDom$contains !== void 0 && _getRefDom$contains.call(_getRefDom, e.target) || hasPopupMouseDown.current) {
        return;
      }
    ...
    _util_dom.on(document, "mousedown", handleDocumentClick);
    _util_dom.on(document, "touchend", handleDocumentClick);
    return function () {
      _util_dom.off(document, "mousedown", handleDocumentClick);
      _util_dom.off(document, "touchend", handleDocumentClick);
    };
