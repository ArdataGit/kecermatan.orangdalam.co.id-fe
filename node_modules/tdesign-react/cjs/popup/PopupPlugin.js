...
var Overlay = function Overlay(originalProps) {
  ...
  var hidePopup = hideEmptyPopup && isString.isString_1(content) && ["", void 0, null].includes(content);
...
var renderInstance = function renderInstance(props, attach) {
  return new Promise(function (resolve) {
    _util_reactRender.render( /* @__PURE__ */React__default["default"].createElement(Overlay, _objectSpread(_objectSpread({}, props), {}, {
...
var createPopupInstance = /*#__PURE__*/function () {
  var _ref3 = index._asyncToGenerator( /*#__PURE__*/index.regenerator.mark(function _callee(trigger, content, popupProps) {
    ...
    var hasTrigger, currentTriggerEl, attach, delay, closeDelay, popupDom, instance, mouseoutEvent, focusoutEvent;
        ...
        case 12:
          ...
          if (hasTrigger.hover) {
            mouseoutEvent = function mouseoutEvent() {
              ...
              _util_dom.off(triggerEl, "mouseleave", mouseoutEvent);
            };
            _util_dom.on(triggerEl, "mouseleave", mouseoutEvent);
          } else if (hasTrigger.focus) {
            focusoutEvent = function focusoutEvent() {
              timeout = setTimeout(removeOverlayInstance, closeDelay);
              _util_dom.off(triggerEl, "focusout", focusoutEvent);
            };
            _util_dom.on(triggerEl, "focusout", focusoutEvent);
          }
