...
var _cacheHas = require('../_chunks/dep-77cbeae0.js');
var _baseGetTag = require('../_chunks/dep-a4fb1294.js');
var eq$1 = require('../_chunks/dep-8bb91473.js');
var _setToArray = require('../_chunks/dep-68af137c.js');
var _baseClone = require('../_chunks/dep-2a862cb7.js');
var _getTag = require('../_chunks/dep-ef8352c0.js');
var isArray$1 = require('../_chunks/dep-e7a0e8b4.js');
var isTypedArray$1 = require('../_chunks/dep-2caefa8e.js');
var isObjectLike$1 = require('../_chunks/dep-315a4a2b.js');
var isFunction = require('../_chunks/dep-7d38d5e1.js');
var _common_js_treeV1_treeStore = require('../_common/js/tree-v1/tree-store.js');
...
var useCascaderContext = function useCascaderContext(props) {
  ...
  React.useEffect(function () {
    if (!treeStore) {
      ...
      var store = new _common_js_treeV1_treeStore.TreeStore({
