...
var isObject = require('../../_chunks/dep-5ed3b3ae.js');
...
require('react-dom');
require('../../_chunks/dep-b489177d.js');
...
var ImageFlowList = function ImageFlowList(props) {
  ...
  var renderImgItem = function renderImgItem(file, index) {
    ...
    var fileName = props.abridgeName && file.name ? _common_js_upload_utils.abridgeName.apply(void 0, [file.name].concat(toConsumableArray._toConsumableArray(props.abridgeName))) : file.name;
    return /* @__PURE__ */React__default["default"].createElement("li", {
      ...
      className: classNames__default["default"](["".concat(uploadPrefix, "__card-status-wrap"), "".concat(uploadPrefix, "__").concat(props.theme, "-").concat(file.status)])
    }, iconMap[file.status], /* @__PURE__ */React__default["default"].createElement("p", null, textMap[file.status])), (["waiting", "success"].includes(file.status) || !file.status && file.url) && /* @__PURE__ */React__default["default"].createElement(image_index.Image, {
  ...
  var renderStatus = function renderStatus(file) {
    ...
    }, (_file$response = file.response) !== null && _file$response !== void 0 && _file$response.error ? file.response.error || textMap[file.status] : textMap[file.status], props.showUploadProgress && file.status === "progress" ? " ".concat(file.percent || 0, "%") : ""));
  };
  ...
  function renderFileThumbnail(file) {
    ...
    if (_common_js_upload_utils.IMAGE_REGEXP.test(fileType) && (file.url || file.raw)) {
  ...
  var renderFileList = function renderFileList() {
    ...
    return /* @__PURE__ */React__default["default"].createElement("table", _objectSpread({
      ...
      var fileName = (_props$abridgeName = props.abridgeName) !== null && _props$abridgeName !== void 0 && _props$abridgeName.length ? _common_js_upload_utils.abridgeName.apply(void 0, [file.name].concat(toConsumableArray._toConsumableArray(props.abridgeName))) : file.name;
      ...
      }, fileNameNode), /* @__PURE__ */React__default["default"].createElement("td", null, _common_js_upload_utils.returnFileSize(file.size)), /* @__PURE__ */React__default["default"].createElement("td", null, renderStatus(file)), disabled ? null : deleteNode);
    })));
  };
  ...
  var renderCancelUploadButton = function renderCancelUploadButton() {
    ...
    if (isFunction.isFunction_1(cancelUploadButton)) return _util_parseTNode["default"](cancelUploadButton);
    var cancelButtonProps = isObject.isObject_1(cancelUploadButton) ? cancelUploadButton : void 0;
  ...
  var renderUploadButton = function renderUploadButton() {
    ...
    if (isFunction.isFunction_1(uploadButton)) return _util_parseTNode["default"](uploadButton);
    var uploadButtonProps = isObject.isObject_1(uploadButton) ? uploadButton : void 0;
    return /* @__PURE__ */React__default["default"].createElement(button_index.Button, _objectSpread({
