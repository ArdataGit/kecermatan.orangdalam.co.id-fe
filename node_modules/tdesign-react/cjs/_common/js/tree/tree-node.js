...
var isNull = require('../../../_chunks/dep-3f013aa5.js');
var isFunction = require('../../../_chunks/dep-7d38d5e1.js');
var isNumber = require('../../../_chunks/dep-0bcf83a3.js');
var isNil = require('../../../_chunks/dep-75155bc0.js');
var isBoolean = require('../../../_chunks/dep-f4b44bcb.js');
...
var TreeNode = /*#__PURE__*/function () {
  function TreeNode(tree, data, parent) {
    ...
    this.draggable = null;
    this[privateKey] = isNil.uniqueId_1(prefix);
    this.value = isNil.isNil_1(get.get_1(data, propValue)) ? this[privateKey] : get.get_1(data, propValue);
    ...
    this.label = get.get_1(data, propLabel) || "";
    this.disabled = get.get_1(data, propDisabled) || false;
  ...
  return createClass._createClass(TreeNode, [{
    ...
    value: function initExpanded() {
      ...
      var config = tree.config;
      if (isNumber.isNumber_1(config.expandLevel) && this.getLevel() < config.expandLevel) {
        ...
        return index.regenerator.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (!isFunction.isFunction_1(config.load)) {
                _context.next = 13;
                break;
              }
              this.loading = true;
    ...
    value: function getChildren(deep) {
      ...
      } else if (isBoolean.isBoolean_1(children)) {
    ...
    value: function isDraggable() {
      var state = !!get.get_1(this, "tree.config.draggable");
    ...
    value: function isExpandMutex() {
      var state = !!get.get_1(this, "tree.config.expandMutex");
    ...
    value: function isActivable() {
      var state = !!get.get_1(this, "tree.config.activable");
    ...
    value: function isCheckable() {
      var state = !!get.get_1(this, "tree.config.checkable");
    ...
    value: function isIndeterminate() {
      ...
      var indeterminate = children.some(function (node) {
        ...
        if (isNull.isNull_1(childChecked)) {
