...
var difference = require('../../../_chunks/dep-61e42795.js');
var camelCase = require('../../../_chunks/dep-106783dc.js');
var isPlainObject = require('../../../_chunks/dep-bd15ffce.js');
...
var TreeStore = /*#__PURE__*/function () {
  function TreeStore(options) {
    ...
    this.hasFilter = isFunction.isFunction_1(config.filter);
  ...
  return createClass._createClass(TreeStore, [{
    ...
    value: function getNode(item) {
      var node = null;
      if (isString.isString_1(item) || isNumber.isNumber_1(item)) {
    ...
    value: function getNodes(item, options) {
      ...
      if (options) {
        ...
        if (isNumber.isNumber_1(conf.level) && conf.level !== Infinity) {
          nodes = nodes.filter(function (node) {
            return node.level <= conf.level;
          });
        }
        if (isFunction.isFunction_1(conf.filter)) {
          nodes = nodes.filter(function (node) {
    ...
    value: function parseNodeData(para, item) {
      ...
      var node = null;
      var data = null;
      if (isString.isString_1(para) || isNumber.isNumber_1(para)) {
        value = para;
    ...
    value: function appendNodes(para, item) {
      ...
      if (spec.data) {
        if (!spec.node) {
          ...
          } else if (isArray.isArray_1(spec.data)) {
    ...
    value: function emit(name, state) {
      ...
      if (isFunction.isFunction_1(method)) {
        method(state);
      }
    ...
    value: function lockFilterPathNodes() {
      ...
      if (!currentFilter || !isFunction.isFunction_1(currentFilter)) return;
