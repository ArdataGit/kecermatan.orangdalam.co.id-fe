...
function handleBeforeUpload(file, params) {
  ...
  var sizePromise = new Promise(function (resolve) {
    var result = null;
    if (sizeLimit) {
      var sizeLimitObj = isNumber.isNumber_1(sizeLimit) ? {
        size: sizeLimit,
        unit: "KB"
      } : sizeLimit;
  ...
  if (isFunction.isFunction_1(beforeUpload)) {
...
function handleError(options) {
  ...
  var res = response;
  if (isFunction.isFunction_1(formatResponse)) {
  ...
  return new Promise(function (resolve) {
    ...
    if (requestMethod) {
      requestMethod(params.multiple ? toUploadFiles : toUploadFiles[0]).then(function (res) {
        ...
        if (isFunction.isFunction_1(params.formatResponse)) {
...
function formatToUploadFile(files, format) {
  ...
  return files.map(function (fileRaw) {
    var file = fileRaw;
    if (isFunction.isFunction_1(format)) {
      file = format(fileRaw);
    }
