...
var InputAdornment = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var renderAddon = function renderAddon(type, classPrefix2, Content) {
    ...
    var addonNode;
    var isContentNode = isString.isString_1(Content) || isNumber.isNumber_1(Content);
  ...
  var renderChildren = function renderChildren() {
    return React__default["default"].Children.map(children, function (child) {
      ...
      if ( /*#__PURE__*/React__default["default"].isValidElement(child)) {
        return /*#__PURE__*/React__default["default"].cloneElement(child, _objectSpread(_objectSpread(_objectSpread({}, wrapperProps), child.props), {}, {
          onChange: function onChange() {
            var _wrapperProps$onChang, _wrapperProps$onChang2, _child$props, _child$props$call;
            ...
            (_child$props = child.props) === null || _child$props === void 0 || (_child$props = _child$props.onChange) === null || _child$props === void 0 || (_child$props$call = _child$props.call) === null || _child$props$call === void 0 || _child$props$call.call.apply(_child$props$call, [_child$props, null].concat(args));
          }
        }));
      }
      return child;
  ...
  return /* @__PURE__ */React__default["default"].createElement("div", {
    ref: ref,
    style: style,
    className: classNames__default["default"]("".concat(classPrefix, "-input-adornment"), className)
