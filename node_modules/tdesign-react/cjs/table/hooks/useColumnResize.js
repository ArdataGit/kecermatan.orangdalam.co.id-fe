...
var isNumber = require('../../_chunks/dep-0bcf83a3.js');
...
function useColumnResize(params) {
  ...
  var onColumnMouseover = function onColumnMouseover(e, col) {
    ...
    if (thRightCursor || isFixedToRight) {
      ...
      if (prevEl) {
        var _effectColMap$current, _effectPrevCol$resiza;
        var effectPrevCol = (_effectColMap$current = effectColMap.current[col.colKey]) === null || _effectColMap$current === void 0 ? void 0 : _effectColMap$current.prev;
  ...
  var getMinMaxColWidth = function getMinMaxColWidth(targetCol) {
    ...
    var propMinWidth = isNumber.isNumber_1(targetCol.minWidth) ? targetCol.minWidth : parseInt(targetCol.minWidth || "0", 10);
    return {
  ...
  var onColumnMousedown = function onColumnMousedown(e, col, index) {
    var _tableContentRef$curr, _effectColMap$current2, _effectColMap$current3;
    ...
    var effectNextCol = (_effectColMap$current2 = effectColMap.current[col.colKey]) === null || _effectColMap$current2 === void 0 ? void 0 : _effectColMap$current2.next;
    var effectPrevCol = (_effectColMap$current3 = effectColMap.current[col.colKey]) === null || _effectColMap$current3 === void 0 ? void 0 : _effectColMap$current3.prev;
    ...
    var onDragEnd = function onDragEnd() {
      var _resizeLineParams$res, _effectColMap$current4;
      ...
      var currentCol = (_effectColMap$current4 = effectColMap.current[col.colKey]) === null || _effectColMap$current4 === void 0 ? void 0 : _effectColMap$current4.current;
      ...
      var canResizeSiblingColWidth = !(isWidthOverflow || index === leafColumns.length - 1);
      ...
      _util_dom.off(document, "mouseup", onDragEnd);
      _util_dom.off(document, "mousemove", onDragOver);
    ...
    _util_dom.on(document, "mouseup", onDragEnd);
    _util_dom.on(document, "mousemove", onDragOver);
