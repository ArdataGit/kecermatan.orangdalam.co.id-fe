...
export default function ManageIsian({
  setVisible,
  params,
  detail,
  setDetail,
  ...
  const handleSubmit = async (data: any) => {
    ...
    const url = detail.id
      ? `admin/kategori-soal-isian/update/${detail.id}`
      : 'admin/kategori-soal-isian/insert';
  ...
  return (
    <Dialog
      header={detail.id ? 'Edit Kategori Isian' : 'Tambah Kategori Isian'}
      visible
      onClose={handleClose}
      className="w-[800px]"
      footer={null}
