...
export default function HistoryDetailKecermatanAdmin() {
  ...
  const getFinalCategory = (score: number) => {
    if (score >= 88) return { label: "Tinggi", color: "text-green-700", bg: "bg-green-100", border: "border-green-300", desc: "Hasil akhir sangat kuat. Konsistensi terjaga dengan baik." };
    ...
    if (score >= 50) return { label: "Rendah", color: "text-orange-700", bg: "bg-orange-100", border: "border-orange-300", desc: "Hasil akhir masih rendah. Fokus pada peningkatan akurasi dan kecepatan." };
